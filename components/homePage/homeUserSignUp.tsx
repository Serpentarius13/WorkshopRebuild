...
const HomeUserSignUp = () => {
  ...
  return (
    <>
      <div className="w-[100%] min-h-[18rem] flex flex-col bg-gray-800 rounded-xl md:flex-row md:space-y-0 relative   items-center justify-around bg-red pt-10 functional-block">
        ...
        />
        {curUser ? (
          <div className="absolute top-1/2 z-[300] -translate-y-1/2 w-[110%] rounded-3xl h-[115%] bg-purple-300 bg-opacity-40 flex items-center justify-center overflow-hidden ">
