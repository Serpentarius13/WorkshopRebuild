...
import SendEmailForm from "../../components/reusable-form/formTypes/sendEmailForm";
    ...
    <div className="w-screen flex items-center justify-center absolute">
      <div className="w-[90%] md:w-[50%]  p-4 flex flex-col items-center space-y-1 ">
        ...
        <h1 className="text-3xl text-black text-center">
          {" "}
          Hello, Im <span className="italic"> Andrei, </span> a front-end
          developer{" "}
        </h1>
        ...
        <p className="text-center text-2xl pt-4">
          ...
          completely by me (thanks Stack Overflow){" "}
        </p>
